...
<body>
    ...
    if ($rastgele_sayi %2 == 0) {
        echo "Sayı Çift : $rastgele_sayi";
    }else{
        echo "Sayı Tek : $rastgele_sayi ";
    }
    ...
    /* 3 */
    echo "<br>";
    $dogumyılı = rand(1957,2022);
    $yas = 2022-$dogumyılı;         
    if ($dogumyılı >= 2004) {
        echo "Ehliyet alamazsınız yaşınız tutmuyor. Yaşınız : $yas";
    }else{
        echo "Ehliyet almaya hakkınız vardır. Yaşınız : $yas ";
    }
